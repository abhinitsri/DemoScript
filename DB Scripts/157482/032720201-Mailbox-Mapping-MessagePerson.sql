...
BEGIN TRY
	...
	select ReceiverPersonID  FROM [MessagePerson] where ReceiverPersonID= 758035 AND MESSAGEID = 421601 ; SET @SelectedRowCount = @SelectedRowCount + @@ROWCOUNT
	...
	UPDATE [MessagePerson] set ReceiverPersonID = 515035 where ReceiverPersonID = 758035 AND MESSAGEID=421601 ; SET @UpdatedRowCount = @UpdatedRowCount + @@ROWCOUNT
