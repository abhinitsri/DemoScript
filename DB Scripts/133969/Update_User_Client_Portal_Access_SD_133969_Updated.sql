...
"SV for AFAS - External User Request - " King University
...
BEGIN TRY
	...
	Update [dbo].[User] SET IsActive = 0 where UserID = 36321
	Update UserRole set IsActive = 0 where UserRoleID = 1448909
