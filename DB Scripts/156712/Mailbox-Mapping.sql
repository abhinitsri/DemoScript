...
BEGIN TRY
	...
	Update MessagePerson set ReceiverPersonID=757744  where ReceiverPersonID=316048  --Inbox Email

	Update [Message] set SenderPersonID=757744  where SenderPersonID=316048   --Send Email
