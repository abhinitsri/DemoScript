...
BEGIN TRY
	BEGIN TRAN PersonUpdate  
	 ...
	 update Person set isactive=0 where Email='Joseph.Bryan@ruffalonl.com' and PersonID=745568
	 update Person set isactive=0 where Email='Mike.Dziedziak@ruffalonl.com' and PersonID=745535
