...
BEGIN TRY
	...
	Update MessagePerson set ReceiverPersonID=758022  where ReceiverPersonID=442233  --Inbox Email

	Update [Message] set SenderPersonID=758022  where SenderPersonID=442233   --Send Email
