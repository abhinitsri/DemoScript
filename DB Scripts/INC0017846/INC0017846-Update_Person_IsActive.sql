Use [NoelLevitz]
/*
  SD#INC0018713 - User is not able to login due to duplicate active account
...
BEGIN TRY
	...
	--SELECT * FROM Person	WHERE Email='jesslynr@nmsu.edu' AND PersonID=747027
	Update Person set IsActive=0 where PersonID=747027 
