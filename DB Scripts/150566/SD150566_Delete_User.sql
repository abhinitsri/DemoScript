...
BEGIN TRY
	...
	Delete from UserRole where UserID ='113260';
	SET @UpdatedRowCount = @UpdatedRowCount + @@ROWCOUNT

	Delete from dbo.UserLoginTracking where UserID ='113260';
	SET @UpdatedRowCount = @UpdatedRowCount + @@ROWCOUNT

	Delete from  dbo.ProfileDetail where ProfileId ='53354';
	SET @UpdatedRowCount = @UpdatedRowCount + @@ROWCOUNT

	Delete from dbo.Profile where UserID ='113260';
	SET @UpdatedRowCount = @UpdatedRowCount + @@ROWCOUNT

	Delete from [User] where UserID ='113260';
	SET @UpdatedRowCount = @UpdatedRowCount + @@ROWCOUNT
