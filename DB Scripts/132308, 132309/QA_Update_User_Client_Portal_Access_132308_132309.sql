Use [NLAuth]
/*
Incident - 132308, 132309

SV for AFAS - External User Request - Robert Morris University and St. Norbert College
...
BEGIN TRY
	...
	Update UserRole set IsActive = 0 where UserRoleID in (1400026,1400765,1400745,1400806,1401419,1400085,1401667)
